...
; This file was generated Wed May 11 20:13:41 2022
;--------------------------------------------------------
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7030:genAssign
	.line	6; "utilities.c"	for(i = 1 ;i<=1000;i++)
	MOVLW	0x01
...
;; ***	genAssign  6928
;;	694 register type nRegs=2
;; 	line = 6937 result AOP_REG=r0x104C, size=2, left -=-, size=0, right AOP_LIT=0x01, size=2
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7030:genAssign
_00115_DS_
	.line	8; "utilities.c"	for(j = 1 ;j<= delay_ms ; j++)
	MOVLW	0x01
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7032:genAssign
;;	1109 rIdx = r0x104C 
	BANKSEL	r0x1004
...
;;	694 register type nRegs=2
;;	694 register type nRegs=2
;; 	line = 7129 result AOP_REG=r0x104E, size=2, left -=-, size=0, right AOP_REG=r0x104C, size=2
;; ***	genCast  7253
...
;;	694 register type nRegs=2
;;	575
;; 	line = 618 result AOP_REG=r0x104C, size=2, left AOP_REG=r0x104C, size=2, right AOP_LIT=0x01, size=1
...
;;signed compare: left >= lit(0x3E9=1001), size=2, mask=ffff
;; ***	mov2w  1381  offset=1
